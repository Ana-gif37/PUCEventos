...
<div class="container theme-showcase" role="main">      
    <div class="page-header">
        <h1>Enviar mensagem aos Administradores do Sistema</h1>
    </div>


    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" method="POST" action="../../Processa/Organizador/ProcessaEnviarMensagemAdministrador.php">
...
<!--                            <input  name="todos" class="form-check-input" type="checkbox" id="selectAll"  ><b> Marcar/Desmarcar Todos</b>-->
                            ...
                            <label class = "form-check-label">
                                ...
                                $event = new Administrador();

                                //LISTA OS PARTICIPANTES
                                $resultado = $event->exibirTodosUsuariosCadastradosAtivos();
                                for ($i = 0; $i < mysqli_num_rows($resultado); $i++) {
                                    $linha = mysqli_fetch_array($resultado);
                                    ?>
                                    <input checked name="administradores[]" class="form-check-input" type="checkbox" id="selectedId" value="<?php echo $linha["ID"]; ?>"> <?php
