...
<div class="container theme-showcase" role="main">      
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" method="POST" action="../../Processa/Organizador/ProcessaEditaEventosInscricaoAberta.php" enctype="multipart/form-data">
...
//LISTA OS PARTICIPANTES
                            ...
                            <input type="hidden" name="id_organizador" value="<?php echo $_SESSION['idOrganizador']; ?>">
