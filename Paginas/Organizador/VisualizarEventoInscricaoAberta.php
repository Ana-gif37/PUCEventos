...
<div class="container theme-showcase" role="main">      
    ...
    <div class="row">
        <div class="pull-right">
            ...
            <a href='../../geradorBoletos/boleto_santander_banespa.php?id=<?php echo $id; ?> &idPartcipante=<?php echo $_SESSION['idOrganizador']; ?>'><button type='button' class='btn btn-sm btn-warning'>Vizualizar Boleto Gerado com Meus Dados</button></a>
