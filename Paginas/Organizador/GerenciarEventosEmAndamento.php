...
$resultadoMeusEventos = $evento->consultarNumeroEventosEmAndamentoOrganizador($_SESSION['idOrganizador']);
...
<div class="container theme-showcase" role="main">
    ...
    <div class="page-header">
        ...
        <div class="row">
                    ...
                    <div class = "col-md-12">
                        <table class = "table">
                            ...
                            <tbody>
                                ...
                                $resultado = $evento->exibirTodosMeusEventosEmAndamento($_SESSION['idOrganizador']);
                                ...
                                <td> 
                                    ...
                                    <a href='index.php?link=32&id=<?php echo $linha['ID']; ?>'><button type='button' class='btn btn-sm btn-success'>Relatórios</button></a>
            ...
            echo "<h3>" . 'Você não possui nenhum evento em andamento' . "</h3>";
        }
        ?>
    </div> <!-- /container -->
