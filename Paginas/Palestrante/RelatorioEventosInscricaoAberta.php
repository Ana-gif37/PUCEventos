    ...
    <div class="page-header">
        ...
        <div class="row">
            ...
            <center> <a href='GerarRelatorioMediaIdades.php?id=<?php echo $evento; ?>'><button type='button' class='btn btn-lg btn-success'>Média de idades</button></a> </center>
                <br><br><br>
                <center><a href='GerarRelatorioQuantidadePessoasInscritas.php?link=47&id=<?php echo $evento; ?>'><button type='button' class='btn btn-lg btn-primary'>Quantidade de Pessoas Inscritas</button></a> </center>
                <br><br><br>
                <center> <a href='GerarRelatorioQuantidadePorSexo.php?id=<?php echo $evento; ?>'><button type='button' class='btn btn-lg btn-info'>Porcentagem de Participantes por sexo</button></a> </center>
