    ...
    <div class="page-header">
        ...
        <div class="row">
            ...
            if ($quantidadeInscritosParticipante > 0) {
                ...
                <center> <button type='button' class='btn btn-lg btn-primary'>Participantes Concluintes</button></a> </center>
                <br><br>
                ...
                <br><br>
                <center> <a href='GerarRelatorioQuantidadePorSexo.php?id=<?php echo $evento; ?>'><button type='button' class='btn btn-lg btn-danger'>Porcentagem de Participantes por sexo</button></a> </center>
