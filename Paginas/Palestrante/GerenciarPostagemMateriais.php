...
//LISTA OS PARTICIPANTES
                                    ...
                                    <td> 
                                        ...
                                        <a href='../../Processa/Palestrante/ProcessaApagarPostagemMateriais.php?id=<?php echo $linha['ID']; ?>&nome=<?PHP echo $linha['NOMEMATERIAL']; ?>&evento=<?PHP echo $idEventos; ?>'><button type='button' class='btn btn-sm btn-danger'>Apagar</button></a>
