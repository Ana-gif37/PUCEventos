        ...
        <br><div class="row">
            <div class="col-md-12">
                <table class="table">
                    ...
                    <form action="index.php?link=49&evento=<?php echo $evento?>" " method="POST">
...
//REALIZA A BUSCA
                            if ($_POST) {
                                ...
                                if ($_POST['pesquisar']) {
                                    ...
                                    $resultado = $participante->ConsultaUsuariosInscritosEventos(1,$usuario);
                                        ...
                                        <td> 
                                            ...
                                            if ($linha['GRATUITOOUPAGO'] == 2) {
                                                ...
                                                if ($linha['ID_SITUACAOGRATUITOOUPAGO'] == 1 or $linha['ATIVO_INATIVO'] == null) {
                                                    ?>
                                                    <a href='../../Processa/Administrador/ProcessaSituacaoParticipanteEvento.php?evento=<?php echo $evento ?>&id=<?php echo $linha['ID']; ?>&situacao=2'><button type='button' class='btn btn-sm btn-success'>  Confirmar Pagamento </button></a>
                                                <?php } ?>
                                                <?php if ($linha['ID_SITUACAOGRATUITOOUPAGO'] == 2) { ?>
                                                    <a href='../../Processa/Administrador/ProcessaSituacaoParticipanteEvento.php?evento=<?php echo $evento ?>&id=<?php echo $linha['ID']; ?>&situacao=1'><button type='button' class='btn btn-sm btn-warning'>  Cancelar Pagamento </button></a>
                                                    <?php
                                                }
                                            }
                                            ?>
                                            ...
                                            <?php if ($linha['ID_SITUACAOGRATUITOOUPAGO'] == 1 or $linha['ID_SITUACAOGRATUITOOUPAGO'] == 2 or $linha['ID_SITUACAOGRATUITOOUPAGO'] == null) { ?>
                                                <a href='../../Processa/Administrador/ProcessaSituacaoParticipanteEvento.php?evento=<?php echo $evento ?>&id=<?php echo $linha['ID']; ?>&situacao=3'><button type='button' class='btn btn-sm btn-danger'>  Cancelar Inscrição </button></a>
                                            <?php } ?>
                                            <?php if ($linha['ID_SITUACAOGRATUITOOUPAGO'] == 3) { ?>
                                                <a href='../../Processa/Administrador/ProcessaSituacaoParticipanteEvento.php?evento=<?php echo $evento ?>&id=<?php echo $linha['ID']; ?>&situacao=1'><button type='button' class='btn btn-sm btn-primary'>  Ativar Inscrição </button></a>
                                            <?php } ?>
                                            <?php
                                            echo "</tr>";
                                        }
