...
<div class="container theme-showcase" role="main">      
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" method="POST" action="../../Processa/Administrador/ProcessaEnviarMensagemOrganizador.php">
...
<!--                            <input  name="todos" class="form-check-input" type="checkbox" id="selectAll"  ><b> Marcar/Desmarcar Todos</b>-->
                            ...
                            <label class = "form-check-label">
                                ...
                                $resultado = $organizador->consultarOrganizadorDoEvento($evento);
                                    ...
                                    ?>
                                    <input name="organizador[]" class="form-check-input" type="checkbox" id="selectedId" value="<?php echo $linha["ID"]; ?>"> <?php
