...
<div class="container theme-showcase" role="main">      
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" method="POST" action="../../Processa/Administrador/ProcessaEditaAdministrador.php">

                 <div class="form-group">
                    <label for="nomePessoa" class="col-sm-2 control-label">Nome Pessoa</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nomePessoa" placeholder="" required="required"  maxlength="50"value="<?php echo $nomePessoa; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="cpfPessoa" id="cpfPessoa" placeholder="" required="required"  maxlength="14"value="<?php echo $CPFPessoa; ?>">
                    </div>
                </div>
