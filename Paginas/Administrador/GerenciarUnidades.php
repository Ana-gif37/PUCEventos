...
$resultadoQ = $unidade->consultarNumeroUnidade();
$linhaQ = mysqli_fetch_array($resultadoQ);
$quantidadeUnidade = $linhaQ['QUANTIDADE_UNIDADE'];
?>
                    ...
                    <div class = "col-md-12">
                        <table class = "table">
                            ...
                            <tbody>
                                ...
                                $resultado = $unidade->exibirTodasUnidadesCadastradas();
                                for ($i = 0; $i < mysqli_num_rows($resultado); $i++) {
                                    ...
                                    ?>
                                <td> 
                                    <a href='index.php?link=23&id=<?php echo $linha['ID']; ?>'><button type='button' class='btn btn-sm btn-primary'>Visualizar</button></a>
                                    ...
                                    <?php if ($linha['ATIVO_INATIVO'] == 0 or $linha['ATIVO_INATIVO'] == 'null') { ?>
                                        <a href='../../Processa/Administrador/ProcessaAtivarUnidade.php?id=<?php echo $linha['ID']; ?>&ativar=1'><button type='button' class='btn btn-sm btn-success'>  Ativar  </button></a>
                                    <?php } ?>
                                    <?php if ($linha['ATIVO_INATIVO'] == 1) { ?>
                                        <a href='../../Processa/Administrador/ProcessaAtivarUnidade.php?id=<?php echo $linha['ID']; ?>&ativar=0'><button type='button' class='btn btn-sm btn-default'>  Desativar  </button></a>
                                    <?php } ?>
                                    <?php
                                    echo "</tr>";
                                }
