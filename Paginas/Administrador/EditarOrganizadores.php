...
<div class="container theme-showcase" role="main">      
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" method="POST" action="../../Processa/Administrador/ProcessaEditaOrganizador.php">

                <div class="form-group">
                    <label for="nomePessoa" class="col-sm-2 control-label">Nome Pessoa</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="nomePessoa" placeholder=""  maxlength="50" required="required" value="<?php echo $nomePessoa; ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="cpfPessoa" name="cpfPessoa" placeholder="" maxlength="14" required="required" value="<?php echo $CPFPessoa; ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group date">
                            <input type="text" class="form-control" id="dataNascimento" name="dataNascimento" placeholder="Formato dd/mm/aaaa" required="required"value="<?php echo date('d/m/Y', strtotime($datanascimento)); ?>">
                ...
                <input type="hidden" name="id" value="<?php echo $idOrganizador; ?>">
