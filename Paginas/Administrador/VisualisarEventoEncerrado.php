...
<div class="container theme-showcase" role="main">      
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-sm-9 col-md-10">
                <?php echo date('d/m/Y H:i:s', strtotime($dataInicioInscricao)); ?> até  <?php echo date('d/m/Y H:i:s', strtotime($dataFimInscricao)); ?> 
            </div>
            ...
            <div class="col-sm-9 col-md-10">
                <?php echo date('d/m/Y H:i:s', strtotime($dataInicioEvento)); ?> até  <?php echo date('d/m/Y H:i:s', strtotime($dataFimEvento)); ?> 
            </div>
            <div class="col-sm-3 col-md-2">
            ...
            <?php if ($gratuitoOuPago == 2) { ?>
                ...
                <div class="col-sm-9 col-md-10">
                    <?php echo date('d/m/Y H:i:s', strtotime($dataVencimento)); ?> 
                </div>
            <?php } ?>
