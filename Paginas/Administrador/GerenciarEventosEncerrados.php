...
$resultadoQ = $evento->consultarNumeroEventosEncerrados();
            ...
            <br><div class="row">
                <div class="col-md-12">
                    <table class="table">
                        ...
                        <form action="index.php?link=36" method="POST">
                    ...
                    <div class = "col-md-12">
                        <table class = "table">
                            ...
                            <tbody>
                                ...
                                $resultado = $evento->exibirTodosEncerrados();
                                ...
                                <td> 
                                    ...
                                    <a href='index.php?link=55&id=<?php echo $linha['ID']; ?>'><button type='button' class='btn btn-sm btn-warning'>Relatórios</button></a>
