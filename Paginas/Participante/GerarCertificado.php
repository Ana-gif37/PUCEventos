...
//LISTA OS PARTICIPANTES
   $resultado = $evento->consultarCodigoEncerradoEmissaoCertificado($idParticipante, $idEvento);
   ...
   $linhaDadosCerficado = 'Participou do evento: ' . $nomeEvento . ' no período de ' . $dataInicio . ' à ' . $dataFim . ' com carga horária de ' . $cargaHoraria . ' horas.';
