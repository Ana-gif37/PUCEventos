...
if ($resultado == true) {
    ?>
<META HTTP-EQUIV=REFRESH CONTENT = '0;http://localhost/PUCEventos/Paginas/Administrador/index.php?link=45&evento=<?php echo $eventoId?>'>
    ...
    ?>
    <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/PUCEventos/Paginas/Administrador/index.php?link=45&evento=<?php echo $eventoId?>'>
