...
//Faz a verificação da extensao do arquivo
        ...
        if (array_search($extensao, $_UP['extensoes']) === false) {
            ...
            if ($resultado == true) {
              ...
              if ($tipoevento == 1) {
                        echo "
			<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/PUCEventos/Paginas/Organizador/index.php?link=3'>
			<script type=\"text/javascript\">
				alert(\"Evento cadastrado com Sucesso.\");
                     ...
                     ";
                        ...
                        echo "
			<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/PUCEventos/Paginas/Organizador/index.php?link=4&id=$id'>
			<script type=\"text/javascript\">
				alert(\"Evento cadastrado com Sucesso.\");
			</script>
                     ";
